...
export const ingredients = [
  ...
  ['kangkong',     'Kangkong',                  'tali',  20],
  ['sitaw',        'Sitaw',                     'tali',  30],
  ['dahon-gabi',   'Dahon ng Gabi',             'tali',  30],
  ...
  ['gata',         'Gata (Coconut milk)',       'L',     104.17],
  ['oyster',       'Oyster sauce',              'L',     666.67],
...
export const dishes = [
  ...
  },
  {
    ...
    items: [['baboy',2,'kg'],['sampalok',2,'pack'],['kangkong',2,'tali'],['labanos',2,'piece'],
  ...
  },
  {
    ...
    items: [['tulingan',2,'kg'],['gata',4,'cup'],['luya',2,'piece'],['bawang',10,'clove'],
            ...
            ['patis',0.5,'cup'],['dahon-sili',1,'tali']],
  ...
  },
  {
    ...
    items: [['tinapa',0.25,'kg'],['kalabasa',1,'piece'],['sitaw',1,'tali'],['gata',4,'cup'],
  ...
  },
  {
    ...
    items: [['sitaw',2,'tali'],['toyo',1,'cup'],['suka',0.5,'cup'],['bawang',12,'clove'],
            ['sibuyas',2,'piece'],['paminta',2,'tsp'],['laurel',6,'piece'],
  ...
  },
  {
    ...
    items: [['tinapa',0.5,'kg'],['dahon-gabi',2,'tali'],['gata',5,'cup'],['bawang',12,'clove'],
